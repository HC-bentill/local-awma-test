...
<div class="row">
  <div class="col">
    <section class="card card-featured-bottom card-featured-primary form-wizard" id="w8">
      ...
      <div class="card-body">
        <div class="wizard-progress wizard-progress-lg">
          ...
          <ul class="nav wizard-steps">
            <li class="nav-item active">
              <a class="nav-link" href="#w8-account" data-toggle="tab"><span>1</span>Personal Info</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#w8-profile" data-toggle="tab"><span>2</span>Location Info</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#w8-billing" data-toggle="tab"><span>3</span>Property Info</a>
            </li>
            <!-- <li class="nav-item">
              <a class="nav-link" href="#w8-confirm" data-toggle="tab"><span>4</span>Facility Info</a>
            </li> -->
          </ul>
        </div>
        ...
        <form class="form-horizontal p-3" enctype="multipart/form-data" autocomplete="off" novalidate="novalidate" method="POST" action="<?=base_url()?>Business/add_business" id="submitForm">
          <div class="tab-content">
            <div id="w8-account" class="tab-pane active">
            ...
            <div id="w8-profile" class="tab-pane">
              <div class="form-group row">
                <div class="col-sm-4">
              ...
              <div class="form-group row" style="display:none;">
                ...
                <div class="col-sm-4" style="display: none;">
                  ...
                  <input type="text" class="form-control" name="form_category" id="form_category" value="busprop" readonly required>
                </div>
              </div>  
              <!-- <div class="form-group row">
                <div class="col-sm-4">
            ...
            <div id="w8-billing" class="tab-pane">
              ...
              <div class="form-group row">
                <div class="col-sm-4">
                  ...
                  <input type="text" class="form-control" onKeyUp="validate_propery_code();" id="property_code" name="property_code" required/>
                ...
                <div class="col-sm-4">
                  ...
                  <select data-plugin-selecttwo="" data-plugin-options="{ &quot;minimumResultsForSearch&quot;: 5 }" name="accessed_status" id="accessed_status" onchange="accessed_new()" class="form-control" required>
                    <option value="">SELECT OPTION</option>
                    <option value="0">Unassessed</option>
                ...
                <div class="col-sm-4">
                  ...
                  <select data-plugin-selecttwo="" data-plugin-options="{ &quot;minimumResultsForSearch&quot;: 5 }" class="form-control" id="class_code" name="class_code" required>
                        ...
                        <?php foreach($class as $c){ ?>
                            <option value="<?= $c->class_code?>"><?=$c->class?></option>
                        <?php } ?>
                  </select>
                </div>
                <div class="col-sm-4">
                  ...
                  <select data-plugin-selecttwo="" data-plugin-options="{ &quot;minimumResultsForSearch&quot;: 5 }" class="form-control" id="zone_code" name="zone_code" required>
                        ...
                        <?php foreach($zone as $z){ ?>
                            <option value="<?= $z->zone_code?>"><?=$z->zone?></option>
                        <?php } ?>
                  </select>
                </div>
                <div class="col-sm-4">
              ...
              <div class="form-group row assessed" style="display:none"> 
                ...
                <div class="col-sm-4">
                  ...
                  <!-- <input type="number" step=".00001" class="form-control" name="rate" required /> -->
                  <input type="number" class="form-control" name="rate" required />
                </div>
              </div>
              <div class="form-group row unassessed" style="display:none">
                <div class="col-sm-4">
                  <label class="control-label text-sm-right pt-2"><strong>Property Category: <span style="color:red;">*</span></strong></label>
                ...
                <div class="col-sm-4">
                  <label class="control-label text-sm-right pt-2"><strong>No Of Rooms: <span style="color:red;">*</span></strong></label>
                  <select data-plugin-selecttwo="" data-plugin-options="{ &quot;minimumResultsForSearch&quot;: 5 }" class="form-control" id="cat2" name="cat2" required>
                      <option value="">N/A</option>
                  </select>
                </div>
                <div class="col-sm-4">
                  <label class="control-label text-sm-right pt-2"><strong>Property Class: <span style="color:red;">*</span></strong></label>
                  <select data-plugin-selecttwo="" data-plugin-options="{ &quot;minimumResultsForSearch&quot;: 5 }" class="form-control" id="cat3" name="cat3" required>
                      <option value="">N/A</option>
                  </select>
                </div>
                <div class="col-sm-4">
                  <label class="control-label text-sm-right pt-2"><strong>Property Type Sub 1: <span style="color:red;">*</span></strong></label>
                  <select data-plugin-selecttwo="" data-plugin-options="{ &quot;minimumResultsForSearch&quot;: 5 }" class="form-control" id="cat4" name="cat4" required>
                      <option value="">N/A</option>
                  </select>
                </div>
                <div class="col-sm-4">
                  <label class="control-label text-sm-right pt-2"><strong>Property Type Sub 2: <span style="color:red;">*</span></strong></label>
                  <select data-plugin-selecttwo="" data-plugin-options="{ &quot;minimumResultsForSearch&quot;: 5 }" class="form-control" id="cat5" name="cat5" required>
                      <option value="">N/A</option>
                  </select>
                </div>
                <div class="col-sm-4">
                  <label class="control-label text-sm-right pt-2"><strong>Property Type Sub 3: <span style="color:red;">*</span></strong></label>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-4">
                  <label class="control-label text-sm-right pt-2"><strong>Supporting Document 1:</strong></label>
                  <input class="form-control" type="file" name="doc1"/>
                </div>
                <div class="col-sm-4">
                  <label class="control-label text-sm-right pt-2"><strong>Supporting Document 2:</strong></label>
            ...
            <div id="w8-confirm" class="tab-pane">
              <!-- <div class="form-group row">
                <div class="col-sm-4">
