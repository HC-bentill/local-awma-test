...
<script type="text/javascript">
	function accessed_new(){
		var prop = document.getElementById("accessed_status").value;
		//alert(prop);
        if( prop == 1){
            $('.assessed').fadeIn('slow');
            $('.unassessed').fadeOut('slow');
        } else{
            $('.assessed').fadeOut('slow');
            $('.unassessed').fadeIn('slow');
        }
	}
</script>
<script type="text/javascript">
...
function check_busprop_code(){
    ...
    if(n < 11){
        ...
        document.getElementById("validate_busprop_code").value = "invalid";
    }else{
            ...
            if(arr == ""){
                ...
                for (var i = 0; i < arr.length; i++) {
                    ...
                    if(userid !== "") {
                        ...
                        document.getElementById("validate_busprop_code").value = "valid";
...
<script>
function validate_propery_code(){

    var property_code = document.getElementById("property_code").value;
    var baseurl = "<?php echo base_url(); ?>";
    var n = property_code.length;
    if(n < 0){
        document.getElementById("status").style.display= "inline-block";
        document.getElementById("statuss").style.display = "none";
        document.getElementById("validate_busprop_code").value = "valid";
        ...
        var url = baseurl + "Business/search_business_prop_code/" + property_code;
        var xmlhttp = new XMLHttpRequest();
        xmlhttp.onreadystatechange=function() {
            if (this.readyState == 4 && this.status == 200) {
                myFunction(this.responseText);
        ...
        function myFunction(response) {
            ...
            if(arr == ""){
                ...
                document.getElementById("statuss").style.display = "inline-block";
                document.getElementById("validate_busprop_code").value = "valid";
                // document.getElementById("property_code_status").value = "Available";
                ...
                for (var i = 0; i < arr.length; i++) {
                    ...
                    if(userid !== "") {
                        ...
                        document.getElementById("statuss").style.display = "none";
                        document.getElementById("validate_busprop_code").value = "invalid";
                        // document.getElementById("property_code_status").value ="Unavailable";
...
<script>
function validate_business_code(){

    var property_code = document.getElementById("business_code").value;
    var baseurl = "<?php echo base_url(); ?>";
    var n = property_code.length;
    if(n < 0){
        document.getElementById("occ_status").style.display= "inline-block";
        document.getElementById("occ_statuss").style.display = "none";
        document.getElementById("validate_bus_code").value = "valid";
    }else{

        var url = baseurl + "Business/search_business_occ_code/" + property_code;
        var xmlhttp = new XMLHttpRequest();
        xmlhttp.onreadystatechange=function() {
            if (this.readyState == 4 && this.status == 200) {
                myFunction(this.responseText);
        ...
        function myFunction(response) {
            var arr = JSON.parse(response);
            if(arr == ""){
                document.getElementById("occ_status").style.display = 'none';
                document.getElementById("occ_statuss").style.display = "inline-block";
                document.getElementById("validate_bus_code").value = "valid";
                // document.getElementById("property_code_status").value = "Available";
                ...
                for (var i = 0; i < arr.length; i++) {
                    ...
                    if(userid !== "") {
                        ...
                        document.getElementById("occ_status").style.display = 'inline-block';
                        document.getElementById("occ_statuss").style.display = "none";
                        document.getElementById("validate_bus_code").value = "invalid";
                        // document.getElementById("property_code_status").value ="Unavailable";
...
<script type="text/javascript">
    function search_owner(){
          ...
          if(a.length < 10){
                ...
                //document.getElementById("use_code").disabled = false;
            ...
            function myFunction(response) {
                ...
                if(arr == ""){
                  ...
                  for (var i = 0; i < arr.length; i++) {
                    ...
                    document.getElementById("houseno").value = arr[i].houseno;
                    //document.getElementById("use_code").value = arr[i].use_code;
                    ...
                    //document.getElementById("use_code").disabled = true;
...
<?php if($title == "Edit Business Property Details" || $title == "Edit Business Occupant Details"):?>
<script type="text/javascript">
