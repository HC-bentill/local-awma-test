              ...
              <div class="row" style="border:1px solid grey;margin-bottom:1em;border-style: dashed;border-radius:1em;padding:1em;">
                <div class="col-lg-12">
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-3 criteria" id="#">
                            <select data-plugin-selecttwo="" data-plugin-options="{ &quot;minimumResultsForSearch&quot;: 5 }" class="form-control"  id="division" name="division">
                ...
                <tbody>
                    <?php foreach($result as $value):?>
                        <tr>
                            ...
                            <td><?= $value->name ?></td>
                            <?php $number = get_batch_print_invoice($value->product_id,$value->category1_id,$value->year,$value->area_id,$value->town_id,$value->division);?>
                            ...
                            <td class="text-center">
                                ...
                                <form method="post" target="_blank" action="<?=base_url()?>Invoice/print_batch_invoice">
                                    ...
                                    <input type="hidden" name="division" value="<?=$value->division?>">
