...
<body>
	...
	<?php if($result->product_id == 12|| $result->product_id == 13){?>
		...
		<div style="margin-bottom: 0px;" class="vee">
			...
			<div style="margin-left: <?=(strlen($ap_invoice_amount) <= 5)?'110px':'70px';?>;"><?= $arrears_amount_text ?></div>
		</div>
	...
	<?php }else if($result->product_id == 1){?>
		...
		<div class="vee">
			...
			<div class="" style="margin-left: 100px;"> FOR:- <?= $result->invoice_year ?> </div>
			<div class="" style="margin-left: 130px;">FOR:- <?= $result->invoice_year ?> </div>
		</div>
		...
		<div class="vee">
			<div class="text-uppercase" style="margin-left: 160px;width:20em;text-align:center;"><?=mb_strimwidth($result->customer_name, 0, 27, "...");?></div>
			<div style="margin-left: 40px;"> <?php echo $result->property_code; ?> </div>
			<div style="margin-left: 90px;"> <?php echo $result->property_code; ?> </div>
		</div>
		...
		<div class="vee">
			<div  style="margin-left: 200px;"> </div>
			<div  style="margin-left: 340px; padding-top: 5px;"> <?= date("m/d/Y", strtotime($result->date_created)) ?> </div>
			<div  style="margin-left: 145px; padding-top: 5px;"> <?= date("m/d/Y", strtotime($result->date_created)) ?> </div>
		</div>
		...
		<div class="vee">
			<div style="margin-left: 160px;"> </div>
			<div style="margin-left: 330px;">  </div>
			<div class="text-uppercase" style="margin-left: 180px;white-space: nowrap;overflow: hidden;"><?=mb_strimwidth($result->customer_name, 0, 20, "...");?> </div>
		</div>
		...
		<div class="vee">
			<div style="margin-left: 160px;"> </div>
			<div style="margin-left: 330px;">  </div>
			<div class="text-uppercase" style="margin-left: 180px;white-space: nowrap;overflow: hidden;"> <?=($result->streetname)?mb_strimwidth($result->streetname, 0, 20, "..."):"-" ?> </div>
		</div>
		...
		<!-- line 9 -->
		<div class="vee">
			<div  style="margin-left: 80px;"><?= number_format((float)$get_last_year_arrears_payment['amount_paid'], 2, '.', ','); ?></div>
			<div style="margin-left: 250px;"><?= $total_amount_text ?> </div>
			<div style="margin-left: 280px;"> <?= $total_amount_text ?> </div>
		</div>
