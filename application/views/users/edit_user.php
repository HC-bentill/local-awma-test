                ...
                <div class="col-sm-12">
	              	<table  id="tbl" class="table table-hover width-full table-responsive">
						...
						<tbody>
							...
							<tr>
								<td><input type="checkbox" class = "chcktbl" id="inputUnchecked" name="role[]" value="special_batch_print_invoice" <?=has_permission($id,'special_batch_print_invoice')?'checked':''?>/></td>
								<td>Special Batch Print Invoice</td>
								<td>This gives user the ability to print specific invoices in batches</td>
							</tr>
						</tbody>
		          	</table>
		        </div>
