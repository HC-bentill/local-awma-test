...
class TaxModel extends CI_Model
{
    ...
    {
        $this->db->select('b.batch_no,b.property_category,b.product as product_id,b.division,b.category1 as category1_id,b.year,b.electoral_area as area_id,b.town as town_id,t.town as town ,a.name as area,r.name, r.target,c.name as category1,b.datetime_created');
