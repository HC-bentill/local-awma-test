...
<div class="modal fade" id="m_modal_2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form id="basicForm" action="<?=base_url("Business/import_arrears_records")?>" enctype="multipart/form-data" method="Post">
          <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">
                     <b>Upload Form</b>
              ...
              <div class="modal-body">
                <div class="form-group row">
                    <div class="col-sm-6">
                        ...
                        <input class="form-control" name="userfile" type="file" id="fileSelect" accept=".csv"/>
                    </div>
                    <!-- <div class="col-sm-6">
